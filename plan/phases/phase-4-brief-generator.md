...
- [ ] Composer: trend picker + offering picker + brief form
...
2. An agent given only "write me a brief for this" produces a brief that
   references the offering's USP and respects its claim guardrails.
...
This is the payoff shot. The sequence — pick offering, two tools appear, ask,
