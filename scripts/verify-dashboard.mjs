...
assert.match(markup, /data-testid="social-source-strip"/)
...
assert.match(markup, /Reach, seven-day direction/)
assert.doesNotMatch(markup, /demo data/i)
...
assert.match(css, /\.sidebar\.is-collapsed/)
